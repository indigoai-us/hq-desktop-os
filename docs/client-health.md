...
| Preview scenarios | `/dev/companion?scenario=health-healthy\|health-degraded\|health-stale\|health-checking\|health-unavailable\|health-unknown` | UI fixtures only (`unknown` → unavailable) |
